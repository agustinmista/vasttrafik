...
function FindTrips(vAPI, lineId, depId, depTrack, destId, destTrack, callback) {
  ...
  vAPI.getDepartureBoard({date: dateNow, time: timeNow, id: depId,  timeSpan: timeSpan}, departures => {
    vAPI.getArrivalBoard({date: dateNow, time: timeNow, id: destId, timeSpan: timeSpan + 60}, arrivals => {
